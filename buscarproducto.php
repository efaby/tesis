...
<table class='table table-th-block'>
  <tr align="center">
    ...
    <?php do { ?>
  <tr>
    <td width="60px" align="center"><?php echo $row_rsProducto['id']; ?></td>
    <td width="120px" align="left"><?php echo $row_rsProducto['producto']; ?></td>
    <td width="80px" align="left"><?php echo $row_rsProducto['marca']; ?></td>
    <td width="80px" align="left"><?php echo $row_rsProducto['modelo']; ?></td>
    <td width="80px" align="center"><?php echo $row_rsProducto['cantidad']; ?></td>
    <td width="80px" align="center"><?php echo $row_rsProducto['precio']; ?> </td>
  </tr>
