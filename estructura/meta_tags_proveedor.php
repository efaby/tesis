...
<head>
    ...
    <script>
   		...
   		//valido la cedula q no sea espacio en blanco
			ruc=document.form1.RUC.value.length
   			if (ruc==0 ){ 
			...
			//valida que la cedula tenga 10 caracteres y no tenga guion
      			...
      			alert("Por favor su RUC debe contener 13 caracteres") 
      			document.form1.RUC.focus() 
      			return 0; 
   			} 
...
function eliminarDato(proveedor){
	...
	if ( eliminar ) {
		...
		ajax.open("GET", "delete_proveedor.php?cod_proveedor="+proveedor);
