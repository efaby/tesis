...
$Sql="Select * from reparacion where informado=1 and id_tecnico in (select id_tecnico from tecnico where cedula = '$user')"; 
...
<tr>
    ...
    <td align="center"> <a class="btn btn-info btn-xs" href='mostrar_informe_tecnico.php?id_reparacion=<?php echo $repara['id_reparacion']?>'> Informe </a> </td>
